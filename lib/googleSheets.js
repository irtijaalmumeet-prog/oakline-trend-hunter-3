...
export async function createClientSheet({ title, header, rows, shareEmail }) {
  ...
  try {
    ...
    linkErr = (e && e.errors && e.errors[0] && e.errors[0].message) || (e && e.message) || 'unknown';
  }
  ...
  return { id: spreadsheetId, url: `https://docs.google.com/spreadsheets/d/${spreadsheetId}/edit`, linkOpen, linkErr };
}
