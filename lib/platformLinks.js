...
export function platformLinks(keyword, country = 'US') {
  const k = enc(keyword);
  return [
    { name: 'Facebook Ads Library', url: `https://www.facebook.com/ads/library/?active_status=all&ad_type=all&country=${country}&q=${k}&search_type=keyword_unordered`, note: 'Filter by date to find ads running 15d–1y' },
    { name: 'TikTok Creative Center', url: `https://ads.tiktok.com/business/creativecenter/inspiration/topads/pc/en?keyword=${k}`, note: 'Top ads & trends' },
